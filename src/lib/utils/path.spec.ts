...
describe('pathHandler', () => {
    describe('getScope', () => {
        ...
        it('should handle paths with query parameters', () => {
            expect(getScope('https://example.com/path/file.txt?query=value')).toBe('https://example.com/path/');
        });

        it('should handle paths with hash fragments', () => {
            expect(getScope('https://example.com/path/file.txt#section')).toBe('https://example.com/path/');
        });
        ...
        it('should handle URLs with port numbers', () => {
            expect(getScope('http://example.com:8080/path/to/file.txt')).toBe('http://example.com:8080/path/to/');
        });
