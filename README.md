...
> [!IMPORTANT]
> **This package is now EOL.** The project has been integrated into native-federation starting with v4 and is now stable. You can find and try out the new orchestrator at https://github.com/native-federation/orchestrator
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/vanilla-native-federation@1.2.1/quickstart.mjs"></script>
  </head>
  <body>
